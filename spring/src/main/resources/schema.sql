...
-- Seed tariffs (ignore if already exists)
INSERT INTO tariffs (id, name, max_projects, max_boards_per_project, max_tasks_per_board, max_file_size_mb, max_storage_mb)
VALUES 
    ('00000000-0000-0000-0000-000000000001', 'free', 3, 3, 50, 10, 100),
    ('00000000-0000-0000-0000-000000000002', 'basic', 10, 10, 200, 50, 500),
    ('00000000-0000-0000-0000-000000000003', 'pro', 50, 50, 1000, 200, 2000)
