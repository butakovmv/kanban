...
internal class AuditLogRepositoryImpl(
    ...
    override suspend fun save(log: AuditLog): AuditLog {
        ...
        """,
            ...
            .let { spec ->
                ...
                if (pid != null) {
                    spec.bind("projectId", UUID.fromString(pid))
                } else {
                    spec.bindNull("projectId", UUID::class.java)
                }
            }.let { spec ->
                val did = table.documentId
                if (did != null) {
                    spec.bind("documentId", UUID.fromString(did))
                } else {
                    spec.bindNull("documentId", UUID::class.java)
                }
            ...
            .let { spec ->
                ...
                if (d != null) {
                    ...
                    spec.bindNull("details", String::class.java)
                }
    ...
    override suspend fun listByProjectId(
        ...
        val total =
            db
                .sql("SELECT COUNT(*) FROM audit_log WHERE project_id = :projectId")
